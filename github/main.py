...
class Github:
    ...
    #
    #     message = "Адрес для отправки уведомлений в этот чат: {}/github/{}\n\n" + \
    ...
    # #
    # #
    # # Route /github/{user_token} handler
    # #
    # #
    # @CodexBot.http_response
    # async def github_route_handler(self, request):
    #     """
    ...
    #         self.sdk.log("github route handler: param 'message' missed")
    #         return {
